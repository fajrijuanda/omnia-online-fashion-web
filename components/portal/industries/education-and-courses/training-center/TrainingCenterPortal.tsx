...
interface TrainingCenterPortalProps {
...
export function TrainingCenterPortal({ activePage, currentTier }: TrainingCenterPortalProps) {
  ...
  const subIndustrySlug = "training-center";
