...
export function LmsPortal({ activePage, currentTier }: LmsPortalProps) {
  ...
  if (subIndustrySlug === "lms") return <div className="p-6"><LmsWorkspace moduleKey={activeModuleKey as any} classes={classes} assignments={assignments} attendance={attendance} grades={grades} /></div>;
