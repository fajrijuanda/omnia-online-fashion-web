...
interface LanguageCoursePortalProps {
...
export function LanguageCoursePortal({ activePage, currentTier }: LanguageCoursePortalProps) {
  ...
  const subIndustrySlug = "language-course";
